...
(
    ...
    alpha_units,
    mu_units,
) = aga3.set_units(units)

# inputs (required)
T_f = 97.649  # flowing temperature
P_f = 87.518  # flowing pressure
dP = 125.963  # orifice differential pressure
d_orifice = 0.625  # measured/reference orifice diameter
D_pipe = 3.0730  # measured/reference meter pipe internal diameter
